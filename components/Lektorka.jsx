    ...
    <div name='lektorka' className='w-full mt-12 md:mt-24'>
      ...
      >
        ...
        <div className='px-0 md:px-10'>
          ...
          <p className='text-justify mb-3'>Tancuji od svého raného dětství. Během svého života jsem prošla snad vsemi tanečním styly. Nejvíce mě oslovuje contemporary a street dance. </p>
          <p className='text-justify mb-3'>Od svých 14 let jsem taneční lektorkou, a tedy mám bohaté zkušenosti s výukou tance.</p>
          ...
          <p className='text-justify mb-3'>Těším se na vás ❤️"</p>
