...
const Lektorka = () => {
  return (
    <div id='lektorka' className='w-full mt-16 md:mt-28'>
      <div
      ...
      >
        ...
        <div className='px-4 py-12'>
          <h2>
              <span className="uppercase font-black"><span className='text-h-color'>pár slov</span> o mně</span>
          </h2>
        </div>
        ...
        <div className='px-0 md:px-10'>
          ...
          <p className='text-justify mb-3'>Prošla jsem tanečními skupinami Paul Dance Jilemnice, se kterou jsme zvítězili na mistrovství světa v kategorii speciální párové tance, a BDS Academy, se kterou jsme se umístili v nabité konkurenci pátí na MS v kategorii Hip hop formation.</p>
          <p className='text-justify mb-3'>Od svých 14 let jsem taneční lektorkou, a tedy mám bohaté zkušenosti s výukou tance. V současné době jsem zaměstnána v taneční škole InDance.</p>
          ...
          <p className='text-justify mb-12'>Těším se na vás ❤️</p>
